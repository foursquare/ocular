...
const fs = require('fs');
const {COLOR, addColor} = require('@probe.gl/log');
const diffImages = require('../utils/diff-images').default;
const eventDispatchers = require('../utils/puppeteer-events');
const BrowserDriver = require('./browser-driver');

const MAX_CONSOLE_MESSAGE_LENGTH = 500;

module.exports = class BrowserTestDriver extends BrowserDriver {
  constructor(options) {
    super(options);
